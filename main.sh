...
clear
rm -f /usr/bin/user
username=$(curl https://raw.githubusercontent.com/nexus-bot-dev/nexus/main/ip | grep $MYIP | awk '{print $2}')
echo "$username" >/usr/bin/user
expx=$(curl https://raw.githubusercontent.com/nexus-bot-dev/nexus/main/ip | grep $MYIP | awk '{print $3}')
echo "$expx" >/usr/bin/e
...
echo -e "\e[32mloading...\e[0m"
clear
REPO="https://raw.githubusercontent.com/nexus-bot-dev/nexus/main/"
start=$(date +%s)
secs_to_human() {
...
clear
restart_system() {
USRSC=$(wget -qO- https://raw.githubusercontent.com/nexus-bot-dev/nexus/main/ip | grep $ipsaya | awk '{print $2}')
